...
const tourSchema = new mongoose.Schema({
    ...
    startLocation: {
        ...
        type: {
            type: String,
            default: 'Point',
            enum: ['Point'] //possible options it could take
        },
        coordinates: [Number],
        address: String,
        description: String
    },
    //locations embedded in tours so array used
    locations: [
        {
            type: {
                type: String,
...
tourSchema.virtual('reviews', {
    ref: 'Review',
    foreignField: 'tour', //the field in the other model i.e reviewmodel where id of the tour is stored
